...
uint8_t USART6_RX_BUF[USART_REC_LEN]; // 接收缓冲,最大USART_REC_LEN个字节.

uint16_t USART6_RX_STA = 0; // 接收状态标记

uint8_t USART6_Recive_flag = 0;
...
void USART6_Init(u32 bound)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8;		  // GPIOC8&blueteeth_state
